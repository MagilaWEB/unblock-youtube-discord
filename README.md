...
### 📌 Важное напоминание
Unblock создан для обхода блокировок в открытом интернете и не предназначен для работы в сетях с «белыми списками» (где запрещено всё, кроме explicitly разрешенного).
...
> [!IMPORTANT]
> Все файлы в папке [`binaries`](./binaries) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws), [hufrea/byedpi](https://github.com/hufrea/byedpi). Вы можете это проверить с помощью хэшей/контрольных сумм.
...
> Информацию про параметры вы можете найти [тут](https://github.com/bol-van/zapret/blob/master/docs/readme.md#nfqws), для Proxy BayDPI [тут](https://github.com/hufrea/byedpi).
