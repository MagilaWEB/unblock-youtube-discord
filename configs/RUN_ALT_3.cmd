...
--filter-tcp=443 %BLOCKLIST% --dpi-desync=fake --dpi-desync-autottl=0  --dpi-desync-skip-nosni=0 --dpi-desync-fooling=badseq --dpi-desync-repeats=3 %FAKE_QUIC% %FAKE_TLS%
