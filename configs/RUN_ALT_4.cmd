...
--filter-tcp=443 --dpi-desync=fake --dpi-desync-autottl=0 --dpi-desync-skip-nosni=0 --dpi-desync-fooling=badseq --dpi-desync-repeats=6 --dpi-desync-fake-tls="%~dp0..\bin\tls_clienthello_www_google_com.bin"

set ARGS2=--wf-tcp=443 ^
-filter-tcp=443 --hostlist="%~dp0russia-blacklist.txt" --dpi-desync=fake,split --dpi-desync-repeats=6 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls="%~dp0..\bin\tls_clienthello_www_google_com.bin"
