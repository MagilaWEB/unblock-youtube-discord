...
--filter-tcp=443 --hostlist="%~dp0russia-blacklist.txt" --dpi-desync=fake --dpi-desync-autottl=1 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%~dp0..\bin\tls_clienthello_www_google_com.bin"
